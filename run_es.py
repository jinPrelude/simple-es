...
def main():
    ...
    parser.add_argument('--cfg-path', type=str, default="conf/lunarlander.yaml", help="config file to run.")
    ...
    loop = builder.build_loop(args.cfg_path, args.generation_num, args.process_num,
